// A Program to solve a system of equations using Gauss-Seidel method.
//Input:
...
//A function subprogram for the Gauss-Seidel method to solve the system of equations
function [x, noit]=ak_Lin_Sys_Gauss_Siedel(a, b, epsilon, maxit)
    try
...
b=[-9;3; 15; 27];
epsilon=.005;
[x,n] = ak_Lin_Sys_Gauss_Siedel(a,b, epsilon,200)
